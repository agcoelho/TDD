...
class TestAvaliador(TestCase):
    ...
    def test_avalia(self):
        ...
        print(f'O menor lance foi de {self.leilao.menor_lance} e o maior foi de {self.leilao.maior_lance}')
    ...
    def test_deve_retornar_o_mesmo_valor_para_maior_e_menor_lance_quando_o_leilao_tiver_um_lance(self):
        ...
        print(f'O menor lance foi de {leilao.menor_lance} e o maior foi de {leilao.maior_lance}')
